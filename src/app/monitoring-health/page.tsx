...
export default function MonitoringHealthPage() {
  return (
    <div className="mx-auto max-w-[1000px]">
      <PageHead mock title="Monitoring Health" sub="The observability platform monitoring itself — ingestion pipelines, alert & notification engines, collectors." crumbs={[{ label: "Settings", href: "/settings" }, { label: "Monitoring Health" }]} />
