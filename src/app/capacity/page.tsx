...
export default function CapacityPage() {
  return (
    <div className="mx-auto max-w-[1000px]">
      <PageHead mock title="Capacity" sub="Resource utilization and forecasts — when each resource is projected to reach its limit." crumbs={[{ label: "Platform", href: "/" }, { label: "Capacity" }]} />
