...
export default function RunbooksPage() {
  return (
    <div className="mx-auto max-w-[1000px]">
      <PageHead mock title="Runbooks" sub="Step-by-step remediation guides, linked directly from alerts and incidents." crumbs={[{ label: "Operations", href: "/" }, { label: "Runbooks" }]} />
