...
export default function QueuesPage() {
  return (
    <div className="mx-auto max-w-[1400px]">
      <PageHead mock title="Queues" sub="SQS and async queues — depth, in-flight, oldest message age, failure rate, and dead-letter counts." crumbs={[{ label: "Observability", href: "/" }, { label: "Queues" }]} />
