...
export default function DatabasesPage() {
  return (
    <div className="mx-auto max-w-[1400px]">
      <PageHead mock title="Databases" sub="CRM databases with CPU, storage, and connection saturation. Open one for the full dashboard." crumbs={[{ label: "Observability", href: "/" }, { label: "Databases" }]} />
