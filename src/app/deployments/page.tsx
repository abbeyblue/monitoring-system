...
export default function DeploymentsPage() {
  return (
    <div className="mx-auto max-w-[1400px]">
      <PageHead mock title="Deployments" sub="Every release correlated with error rate, latency, and resource deltas against the prior version." crumbs={[{ label: "Operations", href: "/" }, { label: "Deployments" }]} />
