...
export default function WebhooksPage() {
  return (
    <div className="mx-auto max-w-[1400px]">
      <PageHead mock title="Webhooks" sub="Inbound webhook processing — received, processed, failed, retried, duplicates, and signature failures." crumbs={[{ label: "CRM", href: "/" }, { label: "Webhooks" }]} />
