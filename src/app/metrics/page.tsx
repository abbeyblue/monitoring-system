...
export default function MetricsPage() {
  return (
    <div className="mx-auto max-w-[1400px]">
      <PageHead mock title="Metrics — Golden Signals" sub="Traffic, latency, errors, and saturation for every service (RED + USE)." crumbs={[{ label: "Observability", href: "/" }, { label: "Metrics" }]} />
