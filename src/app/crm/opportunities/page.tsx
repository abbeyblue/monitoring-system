...
export default function OpportunitiesPage() {
  ...
  return (
    <div className="mx-auto max-w-[1200px]">
      <PageHead mock title="Opportunities" sub="Opportunity creation, stage changes, and closures." crumbs={[{ label: "CRM", href: "/crm" }, { label: "Opportunities" }]} />
      <div className="grid grid-cols-2 gap-2.5 lg:grid-cols-4">
        ...
        <Stat label="Failed updates" value={String(o.failed)} health={o.failed ? "degraded" : "healthy"} href="/crm/service-health/opportunity" />
      </div>
