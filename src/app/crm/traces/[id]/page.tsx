      ...
      <Panel title="Span waterfall">
        ...
        {selSpan && (
          <div className="border-t border-line bg-panel2/40 px-4 py-3 text-xs">
            ...
            {selSpan.kind === "db" && <a href="/crm/databases/crm-prod-db" className="mt-1 inline-block text-2xs text-accent hover:underline cursor-pointer">→ Open database dashboard</a>}
          </div>
        )}
      </Panel>
