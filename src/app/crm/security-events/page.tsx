...
export default function SecurityEventsPage() {
  return (
    <div className="mx-auto max-w-[1200px]">
      <PageHead mock title="Security Events" sub="Authentication and authorization anomalies, privilege changes, rate-limit violations, and sensitive-data access." crumbs={[{ label: "Security", href: "/crm" }, { label: "Security Events" }]} />
