...
export default function InfraPage() {
  return (
    <div className="mx-auto max-w-[1400px]">
      <PageHead mock title="Infrastructure" sub="ECS services, Lambda functions, and EC2 instances." crumbs={[{ label: "Services", href: "/crm/service-health" }, { label: "Infrastructure" }]} />
