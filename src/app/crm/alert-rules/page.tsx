...
export default function AlertRulesPage() {
  return (
    <div className="mx-auto max-w-[1400px]">
      <PageHead mock title="Alert Rules" sub="Threshold and condition rules across APIs, database, queues, Lambda, and backups." crumbs={[{ label: "Incidents", href: "/crm/incidents" }, { label: "Alert Rules" }]} />
