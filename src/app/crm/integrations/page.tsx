...
export default function IntegrationsPage() {
  return (
    <div className="mx-auto max-w-[1400px]">
      <PageHead mock title="Integrations" sub="Third-party and downstream systems — availability, success rate, latency, and sync lag." crumbs={[{ label: "Services", href: "/crm/service-health" }, { label: "Integrations" }]} />
