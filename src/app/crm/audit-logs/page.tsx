...
export default function AuditLogsPage() {
  return (
    <div className="mx-auto max-w-[1200px]">
      <PageHead mock title="Audit Logs" sub="Immutable-style trail of significant actions — who did what, when, from where, with the request id." crumbs={[{ label: "Security", href: "/crm" }, { label: "Audit Logs" }]} />
