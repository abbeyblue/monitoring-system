...
export default function TracesPage() {
  return (
    <div className="mx-auto max-w-[1400px]">
      <PageHead mock title="Traces" sub="Distributed traces across CloudFront → API Gateway → service → cache → database → queue → worker. Open a trace for the span waterfall." crumbs={[{ label: "Logs", href: "/logs" }, { label: "Traces" }]} />
