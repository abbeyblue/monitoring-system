...
export default function IncidentsPage() {
  return (
    <div className="mx-auto max-w-[1400px]">
      <PageHead mock title="Incidents" sub="Correlated incidents — symptoms deduplicated into a single root-cause record with timeline and evidence." crumbs={[{ label: "Operations", href: "/" }, { label: "Incidents" }]} />
