...
export default function LeadsPage() {
  ...
  return (
    <div className="mx-auto max-w-[1200px]">
      <PageHead mock title="Leads" sub="Lead creation, assignment, conversion, and processing failures." crumbs={[{ label: "CRM", href: "/" }, { label: "Leads" }]} />
      <div className="grid grid-cols-2 gap-2.5 lg:grid-cols-4">
        ...
        <Stat label="Processing failures" value={String(l.failed)} health={l.failed ? "degraded" : "healthy"} href="/background-jobs" />
      </div>
