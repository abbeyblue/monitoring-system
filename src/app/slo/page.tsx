...
export default function SloPage() {
  return (
    <div className="mx-auto max-w-[1200px]">
      <PageHead mock title="SLO / SLA" sub="Service-level objectives with error-budget tracking and burn rate." crumbs={[{ label: "Services", href: "/service-health" }, { label: "SLO / SLA" }]} />
