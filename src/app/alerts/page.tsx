...
export default function AlertsPage() {
  return (
    <div className="mx-auto max-w-[1400px]">
      <PageHead mock title="Alerts" sub="Active and recent alerts. Symptoms are correlated into incidents so one failure doesn't page ten times." crumbs={[{ label: "Operations", href: "/" }, { label: "Alerts" }]} />
