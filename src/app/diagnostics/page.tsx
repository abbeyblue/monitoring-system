  ...
  return (
    <div className="mx-auto max-w-[1100px]">
      <PageHead title="Diagnostics" sub="Read-only connection health for the CRM data sources. No cookies, tokens, headers, or raw payloads are shown."
        crumbs={[{ label: "Platform", href: "/" }, { label: "Diagnostics" }]}
        right={<motion.span initial={{ opacity: 0 }} animate={{ opacity: 1 }}><StateBadge state={conn.state} label={conn.label} /></motion.span>} />
