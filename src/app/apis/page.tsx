...
export default function ApisPage() {
  ...
  return (
    <div className="mx-auto max-w-[1400px]">
      <PageHead title="APIs" sub="Live server-side probes of the real CRM endpoints, plus the sample inventory with full latency percentiles." crumbs={[{ label: "Observability", href: "/" }, { label: "APIs" }]} />
